...
public class course_synService {
    private DBOpenHelper dbOpenHelper;
    Context context;
    public course_synService(Context context) {
        super();
...
//			db.insert("course", null, values);
            if (db.isOpen()) {
                ...
                db.execSQL("insert into course_syn (courseid,coursename,courseteacher,courseplace,coursedate,coursetime) " +
...
//
    ...
    public void deletecourse(int id) {
        ...
        try {
            db=dbOpenHelper.getWritableDatabase();
            db.delete("course_syn", "courseid="+id, null);
        } catch (Exception e) {
            // TODO: handle exception
        }finally{
            db.close();
...
//	}
    ...
    public List<course> selectcourse() {
        ...
        try {
            db=dbOpenHelper.getWritableDatabase();
            cursor=db.query("course_syn",null,null,null,null,null,null);
            course course=null;
...
//	}
    ...
    public void updatecourse(int id,String courseName,String courseTeacher,String coursePlace,String courseDate,String courseTime) {
        ...
        try {
            ...
            db.update("course_syn", values, "courseid="+id,null);
